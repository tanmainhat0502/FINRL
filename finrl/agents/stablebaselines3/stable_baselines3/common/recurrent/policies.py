...
# from torch import nn
# from finrl.agents.stablebaselines3.stable_baselines3.common.recurrent.type_aliases import RNNStates
# from finrl.agents.stablebaselines3.stable_baselines3.common.recurrent.ppo_xlstm import PPOxLSTM
...
#         self.lstm_actor = PPOxLSTM(
#             input_size=self.features_dim,  # Giả sử input_size là chiều của observation
